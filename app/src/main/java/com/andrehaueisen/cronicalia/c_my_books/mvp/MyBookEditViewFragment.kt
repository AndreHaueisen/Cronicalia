...
import com.andrehaueisen.cronicalia.c_my_books.DeleteBookAlertDialog
import com.andrehaueisen.cronicalia.c_my_books.EditTextDialog
...
class MyBookEditViewFragment : Fragment(), MyBooksPresenterActivity.PresenterActivity, EditTextDialog.BookChangesListener,
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val view = inflater.inflate(R.layout.c_fragment_my_book_edit, container, false)
