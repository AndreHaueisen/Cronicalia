...
import com.andrehaueisen.cronicalia.c_my_books.MyBookssAdapter
 ...
 */
class MyBooksViewFragment : Fragment(), MyBookssAdapter.CreationClickListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        val rootView = inflater.inflate(R.layout.c_fragment_my_books, container, false)
    ...
    private fun initiateCreationsRecyclerView() {
        ...
        mMyCreationsRecyclerView.adapter = MyBookssAdapter(this, getListOfBooks())
        ...
        launch(UI) {
            mUser.subscribeToUserUpdate().consumeEach {
                ...
                mMyCreationsRecyclerView.adapter?.let {
                    (mMyCreationsRecyclerView.adapter as MyBookssAdapter).updateData(getListOfBooks())
                }
            }
        }
    }
